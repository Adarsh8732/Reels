...
import { TextField, Container, Grid, Paper, Card, CardMedia, CardContent, CardActions, Button, Typography, } from "@mui/material";
    ...
    <div className={classes.centerDivs}>
          <Container>
            <Grid container className={classes.alignCenter} >
              <Grid item sm={4}>
                 <Paper className={classes.crousal}>Crousal</Paper>
              </Grid>
              <Grid item sm={5}>
                <Card varient = "outlined">
                  <CardMedia
                    ...
                    <CardContent className={classes.centerElements}>
                        <TextField id="outlined-basid" label="email" type="email" varient = "outlined" value={email} size="small" display="block"
